...
public class RenshuTest {
    ...
    public void testtRipleValue() {
        assertEquals(3, renshu.doubleValue(2));
        assertEquals(0, renshu.doubleValue(0));
        assertEquals(-9, renshu.doubleValue(-3));
    }
     ...
     * assertEquals(-1, renshu.sumFromArrayIndex(a, 5)); // assuming -1 for invalid
     * index
     * }
     *
     * @Test
     ...
     * int[] b = { 5, -1, -5, 3, -5 };
     * assertEquals(2, renshu.selectMinIndex(b)); // Assuming it returns the first
